...
//  2018TestDemo
//
//  Created by zp on 2019/3/14.
//  Copyright © 2019年 zp. All rights reserved.
//

#import "OC_wkVC.h"
#import <WebKit/WebKit.h>
@interface OC_wkVC ()<WKUIDelegate,WKNavigationDelegate,WKScriptMessageHandler>

@property(nonatomic,weak)WKWebView *webView;

@end

@implementation OC_wkVC
...
- (void)createNav{
    UIView *navView = [[UIView alloc] initWithFrame:CGRectMake(0, NavTopHeight, self.view.frame.size.width, 64)];
...
- (void)createWebView{
    ...
    WKWebView *webView = [[WKWebView alloc] initWithFrame:CGRectMake(0, NavTopHeight*2, self.view.frame.size.width, self.view.frame.size.height - NavTopHeight*2) configuration:config];
